...
*/
	...
	outBuffer[buffCount++] = 0x9f; // Read Identification (RDID)

	// Clock Data Bytes In on +ve Clock Edge MSB First (no Write)
	outBuffer[buffCount++] = 0x20;
	outBuffer[buffCount++] = 0x13; // LengthL
	outBuffer[buffCount++] = 0x00; // Length0
